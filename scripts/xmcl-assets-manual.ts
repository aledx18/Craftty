...
import { getMinecraftLocation, installAssets, parseVersion } from '@/src/minecraft/install.js'
...
console.log(
  `Demo instance location: ${getMinecraftLocation('demo-instance')} (how app will use it)`,
)
...
console.log('=== Done ===')
console.log(
  `Total: ${result.total}, Downloaded: ${result.downloaded}, Skipped: ${result.skipped}, Failed: ${result.failed.length}`,
)
...
console.log(
  "  import { parseVersion, installAssets, getMinecraftLocation } from '@/scripts/minecraft/install.js'",
)
